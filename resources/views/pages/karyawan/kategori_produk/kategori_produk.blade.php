                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                ...
                                <div class="card-header-action">
                                    <a href="{{ route('karyawan.kategori-produk.tambah-kategori-produk') }}"
                                            ...
                                            @foreach ($category_products as $category)
                                                <tr>
                                                    ...
                                                    <td width="10%" class="align-middle">
                                                        <a href="{{ route('karyawan.kategori-produk.edit', $category->slug) }}"
                                                            class="btn btn-icon btn-sm btn-primary">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                        <form method="POST"
                                                            action="{{ route('karyawan.kategori-produk.destroy', $category->slug) }}"
                                                            class="d-inline">
                                                            @csrf
                                                            {{ method_field('delete') }}
