                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                ...
                                <div class="card-header-action">
                                    <a href="{{ route('karyawan.produk.tambah-produk') }}" class="btn btn-primary">
                                        Tambah Data Produk
                                    </a>
                                </div>
                            </div>
                                            ...
                                            @foreach ($products as $produk)
                                                <tr>
                                                    ...
                                                    <td width="10%" class="align-middle">
                                                        <a href="{{ route('karyawan.produk.detail', $produk->slug) }}"
                                                            class="btn btn-icon btn-sm btn-info">
                                                            <i class="fas fa-circle-info"></i>
                                                        </a>
                                                        <a href="{{ route('karyawan.produk.edit-produk', $produk->slug) }}"
                                                            class="btn btn-icon btn-sm btn-primary">
                                                            <i class="fas fa-edit"></i>
                                                        </a>
                                                        {{-- @if (auth()->user()->roles == 'ADMIN') --}}
                                                        <form method="POST"
                                                            action="{{ route('karyawan.produk.destroy', $produk->slug) }}"
                                                            class="d-inline">
                                                            @csrf
                                                            {{ method_field('delete') }}
