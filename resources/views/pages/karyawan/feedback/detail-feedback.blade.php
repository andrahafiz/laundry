        ...
        <section class="section">
            <div class="section-header">
                <div class="section-header-back">
                    <a href="{{ route(Helper::AdminOrUser('feedback.index')) }}" class="btn btn-icon"><i
                            ...
                            <div class="card-body mt-4">
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" class="form-control" name='transactions_id'
                                            value="{{ old('transactions_id') ?? $feedback->transactions_id }}" disabled>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" class="form-control" name='customer_name'
                                            value="{{ old('customer_name') ?? $feedback->customer_name }}" disabled>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" class="form-control" name='nohp_customer'
                                            value="{{ old('nohp_customer') ?? $feedback->nohp_customer }}" disabled>
                                ...
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Pertanyaan
                                        2</label>
                                    <div class="col-sm-12 col-md-7">
                                        <h6 class="">Bagaimana pelayanan yang diberikan karyawan kami Ketika anda
