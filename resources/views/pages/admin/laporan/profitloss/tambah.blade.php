                                                    ...
                                                    <td>
                                                        <div class="form-group mb-0">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text"
                                                                    class="form-control  @error('penjualan_bersih') is-invalid @enderror"
                                                                    name="penjualan_bersih"
                                                                    value="{{ old('penjualan_bersih') }}" placeholder="0"
                                                                    id="penjualan_bersih">
                                                    ...
                                                    <td>
                                                        <div class="form-group mb-0">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text"
                                                                    class="form-control @error('sewa_ruko') is-invalid @enderror"
                                                                    name="sewa_ruko" value="{{ old('sewa_ruko') }}"
                                                                    placeholder="0" id="sewa_ruko">
                                                                @error('sewa_ruko')
                                                                    <div class="invalid-feedback">
                                                                        {{ $message }}
                                                                    </div>
                                                    ...
                                                    <td>
                                                        <div class="form-group mb-0">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text"
                                                                    class="form-control @error('beban_lain') is-invalid @enderror"
                                                                    name="beban_lain" value="{{ old('beban_lain') }}"
                                                                    placeholder="0" id="beban_lain">
                                                                @error('beban_lain')
                                                                    <div class="invalid-feedback">
                                                                        {{ $message }}
                                                                    </div>
                                                    ...
                                                    <td>
                                                        <div class="form-group mb-0">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text"
                                                                    class="form-control  @error('beban_air') is-invalid @enderror"
                                                                    name="beban_air" value="{{ old('beban_air') }}"
                                                                    placeholder="0" id="beban_air">
                                                                @error('beban_air')
                                                                    <div class="invalid-feedback">
                                                                        {{ $message }}
                                                                    </div>
                                                    ...
                                                    <td>
                                                        <div class="form-group mb-0">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text"
                                                                    class="form-control @error('beban_listrik') is-invalid @enderror"
                                                                    name="beban_listrik" value="{{ old('beban_listrik') }}"
                                                                    placeholder="0" id="beban_listrik">
                                                                @error('beban_listrik')
                                                                    <div class="invalid-feedback">
                                                                        {{ $message }}
                                                                    </div>
                                                    ...
                                                    <td>
                                                        <div class="form-group mb-0">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text"
                                                                    class="form-control @error('beban_gaji') is-invalid @enderror"
                                                                    name="beban_gaji" value="{{ old('beban_gaji') }}"
                                                                    placeholder="0" id="beban_gaji">
                                                                @error('beban_gaji')
                                                                    <div class="invalid-feedback">
                                                                        {{ $message }}
                                                                    </div>
                                                    ...
                                                    <td>
                                                        <div class="form-group mb-0">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text"
                                                                    class="form-control  @error('total_beban') is-invalid @enderror"
                                                                    name="total_beban" value="{{ old('total_beban') }}"
                                                                    placeholder="0" id="total_beban" readonly>
                                                                @error('total_beban')
                                                                    <div class="invalid-feedback">
                                                                        {{ $message }}
                                                                    </div>
                                                    ...
                                                    <td>
                                                        <div class="form-group mb-0">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text"
                                                                    class="form-control @error('laba_bersih') is-invalid @enderror"
                                                                    name="laba_bersih" value="{{ old('laba_bersih') }}"
                                                                    placeholder="0" id="laba_bersih" readonly>
                                                                @error('laba_bersih')
                                                                    <div class="invalid-feedback">
                                                                        {{ $message }}
                                                                    </div>
