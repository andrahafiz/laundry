                            ...
                            <div class="card-header">
                                <form class="form-row" method="GET">
                                    <div class="form-group mb-0 ">
                                        <input type="month" class="form-control d-inline" max="{{ now()->format('Y-m') }}"
                                            name="date" required>
                                    </div>
                                                        ...
                                                        <div class="form-group mb-0">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    value="{{ Helper::formatRupiah($data->penjualan_bersih) }}"
                                                                    disabled>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="form-group mb-0">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" name="sewa_ruko"
                                                                    value="{{ Helper::formatRupiah($data->sewa_ruko) }}"
                                                                    disabled>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="form-group mb-0">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" name="beban_lain"
                                                                    value="{{ Helper::formatRupiah($data->beban_lain) }}"
                                                                    disabled>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="form-group mb-0">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" name="beban_air"
                                                                    value="{{ Helper::formatRupiah($data->beban_air) }}"
                                                                    disabled>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="form-group mb-0">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    name="beban_listrik"
                                                                    value="{{ Helper::formatRupiah($data->beban_listrik) }}"
                                                                    disabled>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="form-group mb-0">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" name="beban_gaji"
                                                                    value="{{ Helper::formatRupiah($data->beban_gaji) }}"
                                                                    disabled>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="form-group mb-0">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    name="total_beban"
                                                                    value="{{ Helper::formatRupiah($data->total_beban) }}"
                                                                    disabled>
                                                            </div>
                                                        </div>
                                                    </td>
                                                        ...
                                                        <div class="form-group mb-0">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control" name="pajak"
                                                                    value="{{ Helper::formatRupiah($data->pajak) }}"
                                                                    disabled>
                                                            </div>
                                                        </div>
                                                    </td>
                                                    ...
                                                    <td>
                                                        <div class="form-group mb-0">
                                                            <div class="input-group">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    name="laba_bersih"
                                                                    value="{{ Helper::formatRupiah($data->laba_bersih) }}"
                                                                    disabled>
                                                            </div>
                                                        </div>
                                                    </td>
