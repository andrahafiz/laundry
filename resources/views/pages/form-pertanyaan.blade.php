...
@section('title', 'Feedback | Dapur Amy')
                                    ...
                                    <div id="accordion">
                                                ...
                                                <div class="form-group">
                                                    <div class="selectgroup w-100">
                                                        <label class="selectgroup-item">
                                                            <input type="radio" name="inp_jawaban1" value="5"
                                                                class="selectgroup-input" checked="">
                                                            <span class="selectgroup-button">Sangat Baik</span>
                                                        </label>
                                                        <label class="selectgroup-item">
                                                            <input type="radio" name="inp_jawaban1" value="4"
                                                                class="selectgroup-input">
                                                            <span class="selectgroup-button">Baik</span>
                                                        </label>
                                                        <label class="selectgroup-item">
                                                            <input type="radio" name="inp_jawaban1" value="3"
                                                                class="selectgroup-input">
                                                            <span class="selectgroup-button">Cukup</span>
                                                        </label>
                                                        <label class="selectgroup-item">
                                                            <input type="radio" name="inp_jawaban1" value="2"
                                                                class="selectgroup-input">
                                                            <span class="selectgroup-button">Kurang</span>
                                                        </label>
                                                        <label class="selectgroup-item">
                                                            <input type="radio" name="inp_jawaban1" value="1"
                                                                class="selectgroup-input">
                                        ...
                                        <div class="accordion">
                                            ...
                                            <div class="accordion-body collapse" id="panel-body-2" data-parent="#accordion">
                                                <p class="mb-0">Bagaimana pelayanan yang diberikan karyawan kami Ketika
                                                    anda
                                                ...
                                                <div class="form-group">
                                                    <div class="selectgroup w-100">
                                                        <label class="selectgroup-item">
                                                            <input type="radio" name="inp_jawaban2" value="5"
                                                                class="selectgroup-input" checked="">
                                                            <span class="selectgroup-button">Sangat Baik</span>
                                                        </label>
                                                        <label class="selectgroup-item">
                                                            <input type="radio" name="inp_jawaban2" value="4"
                                                                class="selectgroup-input">
                                                            <span class="selectgroup-button">Baik</span>
                                                        </label>
                                                        <label class="selectgroup-item">
                                                            <input type="radio" name="inp_jawaban2" value="3"
                                                                class="selectgroup-input">
                                                            <span class="selectgroup-button">Cukup</span>
                                                        </label>
                                                        <label class="selectgroup-item">
                                                            <input type="radio" name="inp_jawaban2" value="2"
                                                                class="selectgroup-input">
                                                            <span class="selectgroup-button">Kurang</span>
                                                        </label>
                                                        <label class="selectgroup-item">
                                                            <input type="radio" name="inp_jawaban2" value="1"
                                                                class="selectgroup-input">
                                                            <span class="selectgroup-button">Sangat Kurang</span>
                                                        </label>
                                                    </div>
                                        ...
                                        <div class="accordion">
                                            ...
                                            <div class="accordion-body collapse" id="panel-body-3"
                                                ...
                                                <div class="form-group">
                                                    <div class="selectgroup w-100">
                                                        <label class="selectgroup-item">
                                                            <input type="radio" name="inp_jawaban3" value="5"
                                                                class="selectgroup-input" checked="">
                                                            <span class="selectgroup-button">Sangat Baik</span>
                                                        </label>
                                                        <label class="selectgroup-item">
                                                            <input type="radio" name="inp_jawaban3" value="4"
                                                                class="selectgroup-input">
                                                            <span class="selectgroup-button">Baik</span>
                                                        </label>
                                                        <label class="selectgroup-item">
                                                            <input type="radio" name="inp_jawaban3" value="3"
                                                                class="selectgroup-input">
                                                            <span class="selectgroup-button">Cukup</span>
                                                        </label>
                                                        <label class="selectgroup-item">
                                                            <input type="radio" name="inp_jawaban3" value="2"
                                                                class="selectgroup-input">
                                                            <span class="selectgroup-button">Kurang</span>
                                                        </label>
                                                        <label class="selectgroup-item">
                                                            <input type="radio" name="inp_jawaban3" value="1"
                                                                class="selectgroup-input">
                                                            <span class="selectgroup-button">Sangat Kurang</span>
                                                        </label>
                                                    </div>
                                        ...
                                        <div class="accordion">
                                            ...
                                            <div class="accordion-body collapse" id="panel-body-4"
                                                ...
                                                <div class="form-group">
                                                    <div class="selectgroup w-100">
                                                        <label class="selectgroup-item">
                                                            <input type="radio" name="inp_jawaban4" value="5"
                                                                class="selectgroup-input" checked="">
                                                            <span class="selectgroup-button">Sangat Baik</span>
                                                        </label>
                                                        <label class="selectgroup-item">
                                                            <input type="radio" name="inp_jawaban4" value="4"
                                                                class="selectgroup-input">
                                                            <span class="selectgroup-button">Baik</span>
                                                        </label>
                                                        <label class="selectgroup-item">
                                                            <input type="radio" name="inp_jawaban4" value="3"
                                                                class="selectgroup-input">
                                                            <span class="selectgroup-button">Cukup</span>
                                                        </label>
                                                        <label class="selectgroup-item">
                                                            <input type="radio" name="inp_jawaban4" value="2"
                                                                class="selectgroup-input">
                                                            <span class="selectgroup-button">Kurang</span>
                                                        </label>
                                                        <label class="selectgroup-item">
                                                            <input type="radio" name="inp_jawaban4" value="1"
                                                                class="selectgroup-input">
                                                            <span class="selectgroup-button">Sangat Kurang</span>
                                                        </label>
                                                    </div>
                                        ...
                                        <div class="accordion">
                                            ...
                                            <div class="accordion-body collapse" id="panel-body-5"
                                                ...
                                                <div class="form-group">
                                                    <div class="selectgroup w-100">
                                                        <label class="selectgroup-item">
                                                            <input type="radio" name="inp_jawaban5" value="5"
                                                                class="selectgroup-input" checked="">
                                                            <span class="selectgroup-button">Sangat Baik</span>
                                                        </label>
                                                        <label class="selectgroup-item">
                                                            <input type="radio" name="inp_jawaban5" value="4"
                                                                class="selectgroup-input">
                                                            <span class="selectgroup-button">Baik</span>
                                                        </label>
                                                        <label class="selectgroup-item">
                                                            <input type="radio" name="inp_jawaban5" value="3"
                                                                class="selectgroup-input">
                                                            <span class="selectgroup-button">Cukup</span>
                                                        </label>
                                                        <label class="selectgroup-item">
                                                            <input type="radio" name="inp_jawaban5" value="2"
                                                                class="selectgroup-input">
                                                            <span class="selectgroup-button">Kurang</span>
                                                        </label>
                                                        <label class="selectgroup-item">
                                                            <input type="radio" name="inp_jawaban5" value="1"
                                                                class="selectgroup-input">
                                                            <span class="selectgroup-button">Sangat Kurang</span>
                                                        </label>
                                                    </div>
