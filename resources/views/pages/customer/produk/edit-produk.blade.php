    ...
    <section class="section">
        <div class="section-header">
            <div class="section-header-back">
                <a href="{{ route('customer.produk.index') }}" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
            </div>
                ...
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-body mt-4">
                            <form method="POST" action="{{ route('customer.produk.update', $product->slug) }}" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="text" class="form-control" name='nama' value="{{ old('nama') ?? $product->name_product }}">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="chocolat-parent">
                                                    <a href="{{ Helper::setUrlImage($product->image) }}" class="chocolat-image" title="Foto Produk {{ $product->name }}">
                                                        <div>
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <input type="number" class="form-control" name="stok" value="{{ old('stok') ?? $product->stock }}">
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
                                    <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Harga
                                        Satuan</label>
                                    <div class="col-sm-12 col-md-7">
                                        <input type="number" class="form-control" name="harga" value="{{ old('harga') ?? $product->price }}">
                                    </div>
                                </div>
                                <div class="form-group row mb-4">
