                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            ...
                            <div class="card-header-action">
                                <a href="{{ route('customer.kategori-produk.tambah-kategori-produk') }}" class="btn btn-primary">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td width="10%" class="align-middle">
                                                <a href="{{ route('customer.kategori-produk.edit', $category->slug) }}" class="btn btn-icon btn-sm btn-primary">
                                                    <i class="fas fa-edit"></i>
                                                </a>
                                                <form method="POST" action="{{ route('customer.kategori-produk.destroy', $category->slug) }}" class="d-inline">
                                                    @csrf
                                                    {{ method_field('delete') }}
